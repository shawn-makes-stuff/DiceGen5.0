...
Download the [python script](https://github.com/shawn-makes-stuff/DiceGen5.0/blob/main/blender_dice_gen.py), then go to `Edit > Preferences... > Add-ons > Install...` and select the python file.
